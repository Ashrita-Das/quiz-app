...
import "./App.css";
import shapeTop from "./assets/images/shape1.png";
import shapeBottom from "./assets/images/shape2.png";
...
const App = () => {
  ...
  return (
    <main>
      <img className="shape-top" src={shapeTop} alt="shape at top"/>
        {
          gameStarted 
          ?
      ...
      <img className="shape-bottom" src={shapeBottom} alt="shape at bottom"/>
